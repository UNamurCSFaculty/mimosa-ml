# 🌊 Level 2 — Model abilities

What the model can do beyond a single-output regression: clustering samples, extra output and
channel dimensions, outliers, and non-Gaussian observations.
